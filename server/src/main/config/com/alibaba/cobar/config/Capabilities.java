...
public interface Capabilities {
     ...
     * 客户端的回话等待超时变量变为交互超时变量。
     */
    int CLIENT_INTERACTIVE = 1024;

    /**
     * Switch to SSL after handshake
     * 使用SSL。这个设置不应该被应用程序设置，他应该是在客户端库内部时设置的。
    ...
    /**
     * IGNORE sigpipes
     * 阻止客户端库安装一个SIGPIPE信息处理器
     * 这个可以用于当应用程序已经安装该处理器的时候避免与其发成冲突。
     */
